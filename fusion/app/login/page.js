...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:8082/api/v1/user/login', {
                method: 'POST',
                headers: {
    ...
    return (
        <div className="flex w-full mt-40 max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl scroll-my-0">
            ...
            <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <button onClick={handleSubmit} className="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
